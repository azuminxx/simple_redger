    ...
    historyApp: {
        ...
        fields: {
            ...
            integrationKeyAfter: '統合キー変更後',
                // 新レイアウト用: 変更前/変更後の主キー3種
                beforePCNumber: '変更前PC番号',
                beforeExtNumber: '変更前内線番号',
                beforeSeatNumber: '変更前座席番号',
                afterPCNumber: '変更後PC番号',
                afterExtNumber: '変更後内線番号',
                afterSeatNumber: '変更後座席番号',
                // 新レイアウト用: 変更前/変更後のその他（台帳別）
                beforePCOthers: '変更前PCその他',
                beforeExtOthers: '変更前内線その他',
                beforeSeatOthers: '変更前座席その他',
                afterPCOthers: '変更後PCその他',
                afterExtOthers: '変更後内線その他',
                afterSeatOthers: '変更後座席その他',
            request: 'request',
            response: 'response',
            error: 'error',
            updatedTime: '更新日時',
